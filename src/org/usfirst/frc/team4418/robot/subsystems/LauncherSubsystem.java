...
public class LauncherSubsystem extends Subsystem {
	...
	public WPI_TalonSRX leftLaunchA = new WPI_TalonSRX(RobotMap.leftLaunchA);
	public WPI_TalonSRX leftLaunchB = new WPI_TalonSRX(RobotMap.leftLaunchB);
	public WPI_TalonSRX leftLaunchC = new WPI_TalonSRX(RobotMap.leftLaunchC);
	public WPI_TalonSRX rightLaunchA = new WPI_TalonSRX(RobotMap.rightLaunchA);
	public WPI_TalonSRX rightLaunchB = new WPI_TalonSRX(RobotMap.rightLaunchB);
